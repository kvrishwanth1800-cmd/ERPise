...
- [x] Server-side tenant scope resolver implemented
- [x] Tenant-owned hierarchy create and update implemented
- [x] Cross-tenant and unauthorized scope denial covered by tests
