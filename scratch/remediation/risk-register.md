...
| R-05 | Restore, rollback, dependency failure, and telemetry drills are not executed. | High | RWO-5 | In progress | Execute controlled drills, including full migration rollback and tenant-scoped restore, and record final evidence. |
