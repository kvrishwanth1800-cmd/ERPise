...
class FulfillmentService:
    ...
    def promise(self, scope: ScopeContext, fulfillment_id: str, order_id: str, payment_id: str, method: str, slot_id: str, address: str | None, idempotency_key: str, actor_id: str, trace_id: str) -> FulfillmentPromise:  # noqa: E501
        ...
        self._validate_promise(fulfillment_id, order_id, payment_id, method, slot_id, idempotency_key, trace_id)
        if method == "delivery" and (not address or (scope.tenant_id, address) not in self._serviceable_addresses):  # noqa: E501
    ...
    def assign(self, scope: ScopeContext, fulfillment_id: str, driver_id: str, actor_id: str, trace_id: str) -> FulfillmentPromise:  # noqa: E501
        promise = self._get(scope, fulfillment_id)
    ...
    def dispatch(self, scope: ScopeContext, fulfillment_id: str, actor_id: str, trace_id: str) -> FulfillmentPromise:  # noqa: E501
        promise = self._get(scope, fulfillment_id)
    ...
    def complete(self, scope: ScopeContext, fulfillment_id: str, proof: str, actor_id: str, trace_id: str) -> FulfillmentPromise:  # noqa: E501
        promise = self._get(scope, fulfillment_id)
    ...
    def fail(self, scope: ScopeContext, fulfillment_id: str, outcome: str, actor_id: str, trace_id: str) -> FulfillmentPromise:  # noqa: E501
        promise = self._get(scope, fulfillment_id)
        if promise.status not in {"promised", "assigned", "dispatched"} or outcome not in {"retry", "cancel_refund"}:  # noqa: E501
    ...
    def _validate_promise(self, fulfillment_id: str, order_id: str, payment_id: str, method: str, slot_id: str, idempotency_key: str, trace_id: str) -> None:  # noqa: E501
    ...
    def _transition(self, promise: FulfillmentPromise, status: str, actor_id: str, trace_id: str, **changes: str) -> FulfillmentPromise:  # noqa: E501
        updated = FulfillmentPromise(promise.fulfillment_id, promise.tenant_id, promise.order_id, promise.payment_id, promise.method, promise.slot_id, promise.address, status, changes.get("driver_id", promise.driver_id), changes.get("proof", promise.proof), changes.get("follow_up", promise.follow_up))  # noqa: E501
    ...
    def _record(self, promise: FulfillmentPromise, actor_id: str, trace_id: str, result: str) -> None:
        ...
        self._audit.record(actor_id, "fulfillment", "fulfillment", "customer commitment", "fulfillment", trace_id, result)  # noqa: E501
